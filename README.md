...
> дискриминатор. Кроме того такая техника увеличивает время обучения. Однако имеет смысл
> дальше изучать такую арх-итектуру, пробувать другие стратегии и подбирать гиперпараметры
...
| ResNet18 | ResNet50  | Logits Discriminator |     ✅     |       ❌        |  87.90   |logits_discriminator_unfrozen.ckpt|
